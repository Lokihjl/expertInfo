  ...
  <body>
    <div class="x-body">
        ...
        <input type="hidden" name="id" id="id" value="${paper.id }" >
          ...
          <div class="layui-form-item">
              <label for="username" class="layui-form-label">
                  <span class="x-red">*</span>奖励项目
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="program" name="program" required="" lay-verify="required"
                  autocomplete="off" class="layui-input" value="${paper.program }">
              </div>
          ...
          <div class="layui-form-item">
              <label for="username" class="layui-form-label">
                  <span class="x-red">*</span>奖励等级
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="grade" name="grade" required="" lay-verify="required"
                  autocomplete="off" class="layui-input" value="${paper.grade }">
              </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${paper.year }">
              </div>
