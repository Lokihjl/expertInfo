...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="patentForm"  action="${ctx}/patent/add">
        <input type="hidden" name="id" id="id" value="${patent.id }" >
          ...
          <div class="layui-form-item">
              <label for="username" class="layui-form-label">
                  <span class="x-red">*</span>专利种类
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="type" name="type" required="" lay-verify="required"
                  autocomplete="off" class="layui-input" value="${patent.type }">
              </div>
          ...
          <div class="layui-form-item">
              <label for="username" class="layui-form-label">
                  <span class="x-red">*</span>专利项目名称
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="name" name="name" required="" lay-verify="required"
                  autocomplete="off" class="layui-input" value="${patent.name }">
              </div>
          ...
          <div class="layui-form-item">
              <label for="username" class="layui-form-label">
                  <span class="x-red">*</span>国别
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="country" name="country" required="" lay-verify="required"
                  autocomplete="off" class="layui-input" value="${patent.country }">
              </div>
          ...
          <div class="layui-form-item">
              <label for="username" class="layui-form-label">
                  <span class="x-red">*</span>是否授权
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="grant" name="grant" required="" lay-verify="required"
                  autocomplete="off" class="layui-input" value="${patent.grant }">
              </div>
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${patent.year }">
              </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${patent.remark }">
              </div>
